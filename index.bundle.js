...
function formatDate(dateString)
{
	...
	return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(dateObj, 'EEE, dd MMM yyyy');
}

function displayProjectList(projListObject, projListContainer, taskListContainer)
{
...
function displayTodayList(projObject, taskListContainer)
{
	...
	taskList.forEach(element => {
		...
		if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(dueDateObj))
...
function displayThisWeekList(projObject, taskListContainer)
{
	...
	taskList.forEach(element => {
		let dueDate = element.getDueDate();
		let dueDateObj = new Date(dueDate.substr(0,4), dueDate.substr(5,2) - 1, dueDate.substr(8,2));
		if ((0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)(dueDateObj))
			newList.push(element);
	});
...
function calculatePriority(dueDate)
{
	...
	return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(dueDateObj, today);
}
...
{
	_list_js__WEBPACK_IMPORTED_MODULE_2__.displayProjectList(projList, projListContainer, taskListContainer);
